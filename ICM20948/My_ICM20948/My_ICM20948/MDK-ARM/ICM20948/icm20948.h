...
#define false 0
#define true 1	
#define ICM20948_NUM 5	
#define ICM20945_ID1 0
#define ICM20945_ID2 1
#define ICM20945_ID3 2
#define ICM20945_ID4 3
#define ICM20945_ID5 4

#define M_PI 3.1415

#define i2cAddress 0x68
#define ICM20948_READ   ( (i2cAddress << 1) | 0X01  )
#define ICM20948_WRITE  ( (i2cAddress << 1) | 0x00  )
...
xyzFloat getAccRawValues(void);
xyzFloat getCorrectedAccRawValues(void);
xyzFloat getGValues(void);
xyzFloat getAccRawValuesFromFifo(void);
xyzFloat getCorrectedAccRawValuesFromFifo(void);
xyzFloat getGValuesFromFifo(void);
float getResultantG(xyzFloat gVal);
float getTemperature(void);
xyzFloat getGyrRawValues(void);
xyzFloat getCorrectedGyrRawValues(void);
xyzFloat getGyrValues(void);
xyzFloat getGyrValuesFromFifo(void);
xyzFloat getMagValues(void);
...
char* getOrientationAsString(void);
float getPitch(void);
float getRoll(void);
...
void enableLowPower(uint8_t enLP);
...
//多个设备需要指定ID
void switchBank(uint8_t newBank);			//每个IIC通讯时都会调用
...
xyzFloat readICM20948xyzValFromFifo(void);
