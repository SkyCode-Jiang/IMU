...
#ifndef _INV_ICM20690_DEFS_H_
#define _INV_ICM20690_DEFS_H_
...
#define MPUREG_ACC_CTRL_NEW0     0x0D
 #define BIT_ODR_DLY_TIME_EN_CFG 0x6
#define MPUREG_ANA_CTRL_NEW_1    0x2E
 #define BIT_ODR_DELAY_TIME_EN   0x7
...
#define REG_GYRO_CONFIG_       MPUREG_GYRO_CONFIG
    #define BIT_XG_ST						0x80
    #define BIT_YG_ST						0x40
    #define BIT_ZG_ST						0x20
    #if (MEMS_CHIP == HW_ICM20690)
    #define GYRO_FS_SEL						0x1C
    #else
...
#define REG_ACCEL_CONFIG        MPUREG_ACCEL_CONFIG
    ...
    #define ACCEL_FS_SEL					0x18
    #if (MEMS_CHIP == HW_ICM20690)
    #define ACCEL_FS_SEL_OIS                0x07
    #endif

#define REG_ACCEL_CONFIG_2      MPUREG_ACCEL_CONFIG_2
    #if (MEMS_CHIP != HW_ICM20602)
    #define FIFO_SIZE						0xC0
    #endif
    #define DEC2_CFG						0x30
    #define ACCEL_FCHOICE_B					0x08
    #define A_DLPF_CFG                      0x07
...
#define REG_SIGNAL_PATH_RESET   MPUREG_SIGNAL_PATH_RESET
    #if (MEMS_CHIP == HW_ICM20690)
    #define GYRO_FS_SEL_OIS                 0xE0
    #define FCHOICE_OIS_B                   0x18
    #endif
    #define GYRO_RST_REG                    0x04
    #define ACCEL_RST_REG                   0x02
    #define TEMP_RST_REG                    0x01

#define REG_ACCEL_INTEL_CTRL    MPUREG_ACCEL_INTEL_CTRL
    #define BIT_ACCEL_INTEL_EN              0x80
    #define BIT_ACCEL_INTEL_MODE            0x40
    #if (MEMS_CHIP == HW_ICM20690)
    #define ACCEL_FCHOICE_OIS_B             0x30
    #endif
...
#define REG_INTOSC_CTRL_NEW     0x12
    #define BIT_DELAY_TIME_RD_DISABLE   0x7
...
#endif  /* #ifndef _INV_ICM20690_DEFS_H_ */
