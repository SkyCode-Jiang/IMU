...
{
	return inv_icm406xx_read_reg(s, MPUREG_FIFO_COUNTL, 2, value);
}
...
int inv_icm406xx_rd_gyro_data_ois1(struct inv_icm406xx * s,  uint8_t value[GYRO_DATA_SIZE])
{
	...
	status |= inv_icm406xx_read_reg(s, MPUREG_GYRO_DATA_X0_AUX1_B2, GYRO_DATA_SIZE, (uint8_t *)value);
...
int inv_icm406xx_rd_gyro_data_ois2(struct inv_icm406xx * s,  uint8_t value[GYRO_DATA_SIZE])
{
	...
	status |= inv_icm406xx_read_reg(s, MPUREG_GYRO_DATA_X0_AUX2_B2, GYRO_DATA_SIZE, (uint8_t *)value);
